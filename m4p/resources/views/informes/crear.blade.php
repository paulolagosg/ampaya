        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form  id="fDoctos" method="POST" action="{{ route('informes.agregar') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row col-md-12 m-b-10">  
                            <div class="col-md-4" style="display: table;">
                                ...
                                <span class="col-md-9"> 
                                    ...
                                    <input type="hidden" name="pers_nrut_medico" id="pers_nrut_medico" value="{{ $medico }}">
                                </span>
                            </div>
                                ...
                                <span class="col-md-9">
                                    <select id="tiin_ncod" name="tiin_ncod" class="form-control">
                                        ...
                                        <option value="{{ $dato_a->tiin_ncod}}"
                                            @if(old('tiin_ncod') == $dato_a->tiin_ncod ) selected @endif
                            ...
                            <div class="col-md-5" style="display: table;">
                                ...
                                <span class="col-md-9">
                                    <input type="text" class="form-control" name="pein_tnombre" id="pein_tnombre" value="{{ old('pein_tnombre')}}">
                                </span>
                            </div>
                        </div>                              
                        <div class="form-row col-md-12 m-b-10">  
                            <div class="col-md-12" style="display: table;">
                                ...
                                <span class="col-md-9">
                                    <textarea id="pein_tinforme" name="pein_tinforme" class="form-control">{{ old('pein_tinforme')}}</textarea>
                                </span>
                            </div>
                        </div>
                        <p class="text-right">
