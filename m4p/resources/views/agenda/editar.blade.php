        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white  shadow-sm sm:rounded-lg">
                ...
                @foreach($agenda as $dato)
                	...
                	<form  id="fPacientes" method="POST" action="{{ route('agenda.modificar') }}">
                		@csrf
                		<div class="form-row col-md-12 m-b-10">  
				            <div class="col-md-3" style="display: table;">
				                ...
				                <span class="col-md-9">
				                	<select id="pers_nrut_medico" name="pers_nrut_medico" class="form-control"  onchange="traeHorasMedico(this.value,1)">
				                		<option value="">Seleccione</option>
							            @foreach($medicos as $dato_m)
				                		<option value="{{ $dato_m->pers_nrut}}"
				                			@if(old('pers_nrut_medico') == $dato_m->pers_nrut || $dato->pers_nrut_medico == $dato_m->pers_nrut) selected @endif
				            ...
				            <div class="col-md-3" style="display: table;">
				                ...
				                <span class="col-md-9"> <input type="text" id="agen_finicio" name="agen_finicio" value="{{ old('agen_finicio',$dato->agen_finicio)}}" class="input-sm form-control filter" data-column-index="1" >
				                	<input type="hidden" name="agen_ncod" id="agen_ncod" value="{{ $dato->agen_ncod}}"></span>
				            </div>
				            <div class="col-md-3" style="display: table;">
				                ...
				                <span class="col-md-9"> 
				                	...
				                	<!-- input type="text" id="agen_hinicio" name="agen_hinicio" value="{{ old('agen_hinicio',$dato->agen_hinicio)}}"  class="input-sm form-control filter" data-column-index="2"-->
				                </span>
				            </div>
				            <div class="col-md-3" style="display: table;">
				                ...
				                <span class="col-md-9">
				                	<select id="tipa_ncod" name="tipa_ncod" class="form-control">
				                		...
				                		<option value="{{ $dato_p->tipa_ncod}}"
				                			@if(old('tipa_ncod') == $dato_p->tipa_ncod || $dato_p->tipa_ncod == $dato->tipa_ncod ) selected @endif
						...
						<div class="form-row col-md-12 m-b-10">  
				                ...
				                <span class="col-md-9"> 
				                	<select id="pers_nrut_paciente" name="pers_nrut_paciente" class="form-control select2" searchable="Buscar..." style="width:100% !important">
									    ...
									    @foreach($pacientes as $dato_p)
					                		<option value="{{ $dato_p->pers_nrut}}" @if(old('pers_nrut_paciente') == $dato_p->pers_nrut || $dato->pers_nrut_paciente == $dato_p->pers_nrut) selected @endif >{{ $dato_p->nombre }}</option>
					                	@endforeach
									</select>
				                </span>
				            </div>
				                ...
				                <span class="col-md-9">
				                	<select id="tiat_ncod" name="tiat_ncod" class="form-control">
				                		...
				                		<option value="{{ $dato_a->tiat_ncod}}"
				                			@if(old('tiat_ncod') == $dato_a->tiat_ncod || $dato_a->tiat_ncod == $dato->tiat_ncod ) selected @endif
				            ...
				            <div class="col-md-3" style="display: table;">
				                ...
				                <div class="col-md-3"> 
				                	<input type="checkbox" @if(old('agen_nsobrecupo') == 1 || $dato->agen_nsobrecupo == 1 ) checked @endif id="agen_nsobrecupo" name="agen_nsobrecupo" value="1">
				             	</div>
				             </div>
				             <div class="col-md-3" style="display: table;">
				                <span class="col-md-3 text-bold"><strong>Estado</strong>&nbsp;</span>
				                <span class="col-md-9"> 
				                	<select id="esag_ncod" name="esag_ncod" class="form-control">
				                		<option value="">Seleccione</option>
						...
						<div class="form-row col-md-12 m-b-10">  
				            <div class="col-md-6" style="display: table;">
				                ...
				                <span class="col-md-9"> 
				                	<textarea id="pers_tnota" name="pers_tnota" class="form-control">{{ old('pers_tnota',$dato->pers_tnotas) }}</textarea>
				                </span>
				            </div>
				        </div>
				        <p class="text-right">
...
$(document).ready(function() {
	...
	traeHorasMedico({{$dato->pers_nrut_medico}},1,'{{$dato->agen_hinicio}}');
